      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
            Millions of customers trust Santandaer for secure, fast, and transparent banking.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-600 max-w-2xl mx-auto">
            Built for scale — from individual savers to global enterprises. <span className="text-green-600 font-semibold">Join millions</span> using Santandaer.
          </p>
        </motion.div>
      </div>
    </section>
